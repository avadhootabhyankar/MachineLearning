...
features = data.iloc[:,1:len(feature_names)+1]
print(features.head())
target = data.iloc[:,len(feature_names)+1]
print(target.head())
...
features = oneHotEncode(features, []) #pass the list of columns that needs one hot encoding
